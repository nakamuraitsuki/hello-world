...
# ソフトウェア工学まとめ（第７回以降）
## コードの保守性を高めるために
大きなソフトウェアを開発する中で，自身が書いたコードを元にほかの人間が開発するような場面もしばしばある．

そのような場合に，コードの可読性が低いことは開発速度の低下，ひいては保守性・可用性の低下につながる．

定められているルールは多くあるが，すべてを守ることは難しいし，他人がチェックするわけにもいかない．そこで便利なものが **Linter**である．

ある言語において，慣習的な規則に従っているかどうかを判定，また自動修正してくれるチェックツールのことである．コードの可読性を守るためにもこれを導入することが重要である．

本講義では代表例として`flake8`を扱った．

## バージョン管理のために
開発は段階的に進むことが多く，日々ドキュメントやコードファイルがアップデートされうる．

これらのうちどれが最新であるかを管理するためにバージョンを振るが，それらの更新を人の手で行うと，ミスの原因になったりする．また，多くの場合手間などから更新が途絶える．

そこで，特にソフトウェア開発において強力なバージョン管理ツールとして`git`が挙げられる．

gitは，ソースコードを分散管理することによって高可用性を実現している．

gitは長く使われているために，gitフローと呼ばれる開発手順（フレームワーク）が提唱されていて，広く知られている．
主にブランチを分け，開発酔うブランチで機能を作ってから，mainブランチにマージするという行程を経る．

また，GitHubというサービスによって自動化フローが導入できる．
これによってテストやデプロイの自動化ができ，開発のサイクルがより早く回るようになる．

## ここまでのまとめ
開発におけるコード管理の手法を主に取り扱った．
コードの可読性を保持し，適切なフローで開発に取り組むことは，最適なソフトウェア開発において非常に重要である．